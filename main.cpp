...
{
    cout << "Choose from two: students or engineers (type \"stop\" for shutdown program). ---> ";
    getline(cin, key);
    ...
    if(key=="students"||key=="student")
    {
        ...
        short k = 0;
        //Начиная отсюда заменил все int на unsigned short int или short int.
        //int можно убрать от short, компилятор поймет.
        //Обычный int занимает 4 байта и хранит числа от - 2 147 483 648 до 2 147 483 647
        //short int занимает 2 байта и хранит числа от -32 768 до 32 767
        //unsigned short int занимает 2 байта и хранит числа 0 до 65 535
        //В этом коде ты не работаешь с такими большими числами, какие может хранить int
        //Поэтому его сократили.
